 ...
 */
@WebServlet(description = "a controller used to handle report modification action", urlPatterns = { "/ModifyReport" })
public class ModifyReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action == null) {
			...
			request.getRequestDispatcher("/CreateAbuseReportModifyPage.jsp")
