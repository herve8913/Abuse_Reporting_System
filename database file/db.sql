...
-- Started on 2014-05-01 15:42:09
...
--
-- TOC entry 237 (class 1255 OID 24725)
...
--
-- TOC entry 236 (class 1255 OID 24718)
...
DECLARE
  ...
  subtraction int;
  patient_id1 INT;
  ethnicity_name character varying;
  BEGIN
...
/********PATIENT_LOG_NUMBER****************/
/***************************************/
    SELECT patient.patient_log_number, ethnicity.master_data_name 
    FROM patient,ethnicity WHERE patient.id=patient_id1 
    AND patient.ethnicity_id=ethnicity.id INTO cursor1;
      IF(cursor1.patient_log_number IS NOT NULL)THEN
        patient_log_number_var:=cursor1.patient_log_number;
        ethnicity_name:=cursor1.master_data_name;
      END IF;
...
/***************************************/
    ...
    END IF; 
        ...
        IF(band=TRUE)THEN
          ...
          patient_log_number=patient_log_number_var,ethnicity=ethnicity_name,
          date_of_last_incident=date_of_last_incident1 WHERE id= NEW.id;
        ELSE
          UPDATE abusereport SET public_log_number=public_log_number_var,ethnicity=ethnicity_name,
          patient_log_number=patient_log_number_var WHERE id= NEW.id;
        END IF;
/*********************************************************/
/**************NOW INSERT THE DISABILITIES****************/
/*********************************************************/
...
--
-- TOC entry 239 (class 1255 OID 16417)
...
CREATE FUNCTION update_lastmodified_column() RETURNS trigger
  ...
  BEGIN
    ...
    IF (TG_TABLE_NAME='abusereport')THEN
     IF((NEW.status=2) AND (NEW.submitted_by_staff_date IS  NULL))THEN
       NEW.submitted_by_staff_date=current_date; 
     END IF; 
     IF((NEW.status=3) AND (NEW.approved_by_supervisor_date IS  NULL))THEN
       NEW.approved_by_supervisor_date=current_date; 
     END IF;
     IF((NEW.status=4) AND (NEW.disposition_letter_date IS  NULL))THEN
       NEW.disposition_letter_date=current_date; 
     END IF;
     IF((NEW.status=5) AND (NEW.due_date IS  NULL))THEN
      ...
      NEW.decision_letter_date=current_date;
      NEW.due_date:=date1;
     END IF;
     IF((NEW.status=6) AND (NEW.appeal_letter_date IS  NULL))THEN
       NEW.appeal_letter_date=current_date; 
     END IF; 
    END IF;
    RETURN NEW;
  END;
...
CREATE TABLE abusereport (
    ...
    appeal_letter character varying(255),
    due_date date,
    patient_log_number character varying(255),
    disposition_letter_date date,
    decision_letter_date date,
    appeal_letter_date date,
    approved_by_supervisor_date date,
    submitted_by_staff_date date,
...
CREATE VIEW view_abuse_report AS
 SELECT ar.disposition_letter_date,
    ar.decision_letter_date,
    ar.appeal_letter_date,
    ar.approved_by_supervisor_date,
    ar.submitted_by_staff_date,
    ar.ethnicity,
    ar.id,
    ar.status,
    ar.patient_log_number,
...
--
-- TOC entry 220 (class 1259 OID 32926)
-- Name: view_group_org; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW view_group_org AS
 SELECT g.created,
    g.modified,
    g.status,
    g.master_data_name,
    ...
    g.address,
    g.healthcareorg_id,
    h.master_data_name AS healthorg
   FROM group_home g,
    healthcareorg h
  WHERE (g.healthcareorg_id = h.id);


ALTER TABLE public.view_group_org OWNER TO postgres;
...
--
-- TOC entry 2013 (class 2604 OID 16662)
...
--
-- TOC entry 2021 (class 2604 OID 16663)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2024 (class 2604 OID 16664)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2027 (class 2604 OID 16665)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2105 (class 2604 OID 24590)
...
--
-- TOC entry 2031 (class 2604 OID 16666)
...
--
-- TOC entry 2032 (class 2604 OID 16667)
...
--
-- TOC entry 2033 (class 2604 OID 16668)
...
--
-- TOC entry 2034 (class 2604 OID 16669)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2035 (class 2604 OID 16670)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2036 (class 2604 OID 16671)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2037 (class 2604 OID 16672)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2038 (class 2604 OID 16673)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2042 (class 2604 OID 16674)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2046 (class 2604 OID 16675)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2049 (class 2604 OID 16676)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2053 (class 2604 OID 16677)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2057 (class 2604 OID 16678)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2064 (class 2604 OID 16685)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2065 (class 2604 OID 16686)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2066 (class 2604 OID 16687)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2067 (class 2604 OID 16688)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2068 (class 2604 OID 16689)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2069 (class 2604 OID 16690)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2070 (class 2604 OID 16691)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2071 (class 2604 OID 16692)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2072 (class 2604 OID 16693)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2073 (class 2604 OID 16694)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2074 (class 2604 OID 16695)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2075 (class 2604 OID 16696)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2076 (class 2604 OID 16697)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2077 (class 2604 OID 16698)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2082 (class 2604 OID 16699)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2085 (class 2604 OID 16700)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2086 (class 2604 OID 16701)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2087 (class 2604 OID 16702)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2088 (class 2604 OID 16703)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2092 (class 2604 OID 16704)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2097 (class 2604 OID 16705)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2098 (class 2604 OID 16706)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2099 (class 2604 OID 16707)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2100 (class 2604 OID 16708)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2101 (class 2604 OID 16709)
-- Name: created; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2102 (class 2604 OID 16710)
-- Name: modified; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2103 (class 2604 OID 16711)
-- Name: status; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2104 (class 2604 OID 16712)
-- Name: id; Type: DEFAULT; Schema: public; Owner: abusereportuser
--
...
--
-- TOC entry 2344 (class 0 OID 16418)
-- Dependencies: 170
...
--
-- TOC entry 2345 (class 0 OID 16435)
-- Dependencies: 171
-- Data for Name: abuse_report_disability; Type: TABLE DATA; Schema: public; Owner: abusereportuser
--

INSERT INTO abuse_report_disability (id, created, modified, disability_id, disability_name, disability_comment, patient_id, abusereport_id) VALUES (128, '2014-05-01', '2014-05-01 15:14:06.402', 1, 'Anosmia ', 'Anosmia ', 6, 102);
INSERT INTO abuse_report_disability (id, created, modified, disability_id, disability_name, disability_comment, patient_id, abusereport_id) VALUES (129, '2014-05-01', '2014-05-01 15:14:06.402', 3, 'Hyperosmia', 'Hyperosmia', 6, 102);
INSERT INTO abuse_report_disability (id, created, modified, disability_id, disability_name, disability_comment, patient_id, abusereport_id) VALUES (130, '2014-05-01', '2014-05-01 15:14:06.402', 2, 'Dysosmia', 'Dysosmia', 6, 102);
...
SELECT pg_catalog.setval('abuse_report_disability_id_seq', 130, true);


--
-- TOC entry 2347 (class 0 OID 16445)
-- Dependencies: 173
...
--
-- TOC entry 2350 (class 0 OID 16457)
-- Dependencies: 176
...
--
-- TOC entry 2388 (class 0 OID 24587)
-- Dependencies: 214
-- Data for Name: abusereport; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO abusereport (id, created, modified, status, public_log_number, reporter_id, reporter_name, reporter_address, reporter_telephone, mandated, reporter_relationship_to_victim, alleged_victim_patient_id, alleged_victim_name, alleged_victim_address, alleged_victim_telephone, alleged_victim_sex, alleged_victim_staff_id, alleged_victim_datebirth, alleged_victim_marital_status_id, alleged_abuser_patient_id, alleged_abuser_staff_id, alleged_abuser_name, alleged_abuser_address, alleged_abuser_relationship, alleged_abuser_social_security, alleged_abuser_datebirth, alleged_abuser_telephone, comunication_need, client_guardian_id, client_guardian_name, client_guardian_address, client_guardian_relationship, client_guardian_telephone, currently_served_by_id, currently_served_by_department, collateral_contacts_notification, type_of_service, type_of_abusereport, frequency_of_abuse, is_victim_aware, date_of_last_incident, description_alleged_report, description_level_risk, description_resulting_injuries, description_witnesses, description_caregiver_relationship, oral_report_filed, oral_report_filed_comment, risk_to_investigator, risk_to_investigator_comment, disposition_letter, decision_letter, appeal_letter, due_date, patient_log_number, disposition_letter_date, decision_letter_date, appeal_letter_date, approved_by_supervisor_date, submitted_by_staff_date, ethnicity) VALUES (101, '2014-05-01', '2014-05-01 15:07:22.39', 2, 'PUBLIC-LOG-000101', 2, 'Mark Twain', '12asdfad', '508-8762347', 'Yes', 'Brother', 7, 'Michael sd Stype', 'Park avenue', '132132312                                                                                           ', 'M', NULL, '1980-01-01', 2, NULL, 5, 'User Name', '13 sdafads', 'Brother', NULL, '1980-02-01', '1232131232', 'TTY', 2, 'Mark Twain', '12asdfad', NULL, NULL, 2, 'Dept. of Developmental Svcs. 
', '213', 'Institutional 
', 'Physical', 'Daily 
', 'Yes', NULL, '123', '123', '123', '123', '213', 'Yes', '', 'Yes', '', NULL, NULL, NULL, NULL, 'PATIENT-000007', NULL, NULL, NULL, NULL, '2014-05-01', 'Asian
');
INSERT INTO abusereport (id, created, modified, status, public_log_number, reporter_id, reporter_name, reporter_address, reporter_telephone, mandated, reporter_relationship_to_victim, alleged_victim_patient_id, alleged_victim_name, alleged_victim_address, alleged_victim_telephone, alleged_victim_sex, alleged_victim_staff_id, alleged_victim_datebirth, alleged_victim_marital_status_id, alleged_abuser_patient_id, alleged_abuser_staff_id, alleged_abuser_name, alleged_abuser_address, alleged_abuser_relationship, alleged_abuser_social_security, alleged_abuser_datebirth, alleged_abuser_telephone, comunication_need, client_guardian_id, client_guardian_name, client_guardian_address, client_guardian_relationship, client_guardian_telephone, currently_served_by_id, currently_served_by_department, collateral_contacts_notification, type_of_service, type_of_abusereport, frequency_of_abuse, is_victim_aware, date_of_last_incident, description_alleged_report, description_level_risk, description_resulting_injuries, description_witnesses, description_caregiver_relationship, oral_report_filed, oral_report_filed_comment, risk_to_investigator, risk_to_investigator_comment, disposition_letter, decision_letter, appeal_letter, due_date, patient_log_number, disposition_letter_date, decision_letter_date, appeal_letter_date, approved_by_supervisor_date, submitted_by_staff_date, ethnicity) VALUES (102, '2014-05-01', '2014-05-01 15:15:07.651', 4, 'PUBLIC-LOG-000102', 2, 'Mark Twain', '12asdfad', '508-8762347', 'Yes', 'Brother', 6, 'Dexter A Morgan', '79 Wester Avenue', '213213213                                                                                           ', 'M', NULL, '1980-01-01', 2, NULL, 5, 'User Name', '13 sdafads', 'Brother', NULL, '1980-02-01', '1232131232', 'TTY', 2, 'Mark Twain', '12asdfad', NULL, NULL, 1, 'Dept. of Mental Health 
', '123', 'Institutional 
', 'Physical', 'Daily 
', 'Yes', NULL, '123', '213', '123', '123', '123', 'Yes', '', 'Yes', '', 'abuse.sql', NULL, NULL, NULL, 'PATIENT-000006', '2014-05-01', NULL, NULL, '2014-05-01', '2014-05-01', 'African American 
');
...
SELECT pg_catalog.setval('abusereport_id_seq', 102, true);


--
-- TOC entry 2353 (class 0 OID 16476)
-- Dependencies: 179
...
--
-- TOC entry 2355 (class 0 OID 16487)
-- Dependencies: 181
...
--
-- TOC entry 2357 (class 0 OID 16498)
-- Dependencies: 183
...
', 'Seizures 
', 7);
INSERT INTO disability (id, created, modified, status, disability_name, description, disability_type_id) VALUES (2, '2014-03-10', '2014-04-30 00:33:31.988', 1, 'Dysosmia', 'Dysosmia', 4);
...
SELECT pg_catalog.setval('disability_id_seq', 35, true);


--
-- TOC entry 2359 (class 0 OID 16510)
-- Dependencies: 185
...
--
-- TOC entry 2361 (class 0 OID 16517)
-- Dependencies: 187
...
--
-- TOC entry 2363 (class 0 OID 16527)
-- Dependencies: 189
...
INSERT INTO drug (id, created, modified, status, drug_name, description) VALUES (10, '2014-03-10', '2014-04-29 22:43:23.478', 1, 'Azilect', 'Azilect');
...
--
-- TOC entry 2365 (class 0 OID 16539)
-- Dependencies: 191
...
--
-- TOC entry 2367 (class 0 OID 16546)
-- Dependencies: 193
...
--
-- TOC entry 2369 (class 0 OID 16557)
-- Dependencies: 195
...
--
-- TOC entry 2371 (class 0 OID 16568)
-- Dependencies: 197
...
SELECT pg_catalog.setval('group_home_id_seq', 5, true);


--
-- TOC entry 2373 (class 0 OID 16579)
-- Dependencies: 199
...
--
-- TOC entry 2375 (class 0 OID 16590)
-- Dependencies: 201
...
--
-- TOC entry 2352 (class 0 OID 16467)
-- Dependencies: 178
...
--
-- TOC entry 2377 (class 0 OID 16601)
-- Dependencies: 203
-- Data for Name: patient; Type: TABLE DATA; Schema: public; Owner: abusereportuser
--

INSERT INTO patient (id, created, modified, status, patient_name, patient_midname, patient_last_name, patient_log_number, iq, birthdate, sex, telephone, marital_status_id, group_home_id, currently_served_by_id, client_guardian_id, ethnicity_id) VALUES (7, '2014-03-10', '2014-04-30 14:28:11.864', 1, 'Michael', 'sd', 'Stype', 'PATIENT-000007', 21, '1980-01-01', 'M', '132132312                                                                                           ', 2, 2, 2, 2, 3);
INSERT INTO patient (id, created, modified, status, patient_name, patient_midname, patient_last_name, patient_log_number, iq, birthdate, sex, telephone, marital_status_id, group_home_id, currently_served_by_id, client_guardian_id, ethnicity_id) VALUES (6, '2014-03-10', '2014-04-30 14:28:17.951', 1, 'Dexter', 'A', 'Morgan', 'PATIENT-000006', 71, '1980-01-01', 'M', '213213213                                                                                           ', 2, 1, 1, 2, 4);
INSERT INTO patient (id, created, modified, status, patient_name, patient_midname, patient_last_name, patient_log_number, iq, birthdate, sex, telephone, marital_status_id, group_home_id, currently_served_by_id, client_guardian_id, ethnicity_id) VALUES (8, '2014-03-10', '2014-04-30 14:28:23.557', 1, 'John', 'rafael', 'Doe', 'PATIENT-000008', 71, '1980-01-01', 'M', '213213213                                                                                           ', 2, 2, 1, 5, 1);
INSERT INTO patient (id, created, modified, status, patient_name, patient_midname, patient_last_name, patient_log_number, iq, birthdate, sex, telephone, marital_status_id, group_home_id, currently_served_by_id, client_guardian_id, ethnicity_id) VALUES (10, '2014-03-10', '2014-05-01 00:53:27.274', 1, 'Miguel', 'Angel', 'Sorriano', 'PATIENT-000010', 2, '1980-01-01', 'M', '213213213                                                                                           ', 2, 1, 2, 5, 2);
...
--
-- TOC entry 2379 (class 0 OID 16615)
-- Dependencies: 205
...
--
-- TOC entry 2381 (class 0 OID 16626)
-- Dependencies: 207
...
INSERT INTO system_user (id, created, modified, user_type, status, user_name, user_last_name, login, login_password, social_security, telephone, birthdate, marital_status_id, supervisor_id, user_address, sex) VALUES (9, '2014-04-29', '2014-04-30 14:49:58.075', 4, 1, 'hello', 'world', 'whello', '123', '21321321312', '21321321312', '2010-03-03', 1, NULL, '213213213', 'M');
INSERT INTO system_user (id, created, modified, user_type, status, user_name, user_last_name, login, login_password, social_security, telephone, birthdate, marital_status_id, supervisor_id, user_address, sex) VALUES (5, '2014-04-09', '2014-04-30 15:32:37.038', 3, 1, 'User', 'Name', 'cs509group1@wpi.edu', '123', NULL, '1232131232', '1980-02-01', 1, NULL, '13 sdafads', 'M');
INSERT INTO system_user (id, created, modified, user_type, status, user_name, user_last_name, login, login_password, social_security, telephone, birthdate, marital_status_id, supervisor_id, user_address, sex) VALUES (7, '2014-04-26', '2014-04-30 23:17:32.183', 2, 1, 'Mike', 'Smith', 'msmith', '123', NULL, '5082625986', '1980-02-03', 1, NULL, '24 Trowbridge Rd, Worcester, MA, 01609', 'M');
INSERT INTO system_user (id, created, modified, user_type, status, user_name, user_last_name, login, login_password, social_security, telephone, birthdate, marital_status_id, supervisor_id, user_address, sex) VALUES (2, '2014-03-10', '2014-05-01 03:03:39.447', 3, 1, 'Mark', 'Twain', 'mtwain', '123', 'null', '508-8762347', '1980-01-01', 1, NULL, '12asdfad', 'F');
...
SELECT pg_catalog.setval('system_user_id_seq', 10, true);


--
-- TOC entry 2383 (class 0 OID 16640)
-- Dependencies: 209
...
--
-- TOC entry 2385 (class 0 OID 16651)
-- Dependencies: 211
...
--
-- TOC entry 2117 (class 2606 OID 16716)
...
--
-- TOC entry 2113 (class 2606 OID 16718)
...
--
-- TOC entry 2119 (class 2606 OID 16720)
...
--
-- TOC entry 2171 (class 2606 OID 24601)
...
--
-- TOC entry 2123 (class 2606 OID 16722)
...
--
-- TOC entry 2125 (class 2606 OID 16724)
...
--
-- TOC entry 2127 (class 2606 OID 16726)
...
--
-- TOC entry 2131 (class 2606 OID 16728)
...
--
-- TOC entry 2133 (class 2606 OID 16730)
...
--
-- TOC entry 2129 (class 2606 OID 16732)
...
--
-- TOC entry 2135 (class 2606 OID 16734)
...
--
-- TOC entry 2137 (class 2606 OID 16736)
...
--
-- TOC entry 2139 (class 2606 OID 16738)
...
--
-- TOC entry 2143 (class 2606 OID 16740)
...
--
-- TOC entry 2145 (class 2606 OID 16742)
...
--
-- TOC entry 2141 (class 2606 OID 16744)
...
--
-- TOC entry 2147 (class 2606 OID 16746)
...
--
-- TOC entry 2149 (class 2606 OID 16748)
...
--
-- TOC entry 2151 (class 2606 OID 16750)
...
--
-- TOC entry 2153 (class 2606 OID 16752)
...
--
-- TOC entry 2157 (class 2606 OID 16758)
...
--
-- TOC entry 2159 (class 2606 OID 16760)
...
--
-- TOC entry 2161 (class 2606 OID 16762)
...
--
-- TOC entry 2165 (class 2606 OID 16766)
...
--
-- TOC entry 2167 (class 2606 OID 16768)
...
--
-- TOC entry 2169 (class 2606 OID 16770)
...
--
-- TOC entry 2225 (class 2620 OID 16771)
...
--
-- TOC entry 2214 (class 2620 OID 16772)
...
--
-- TOC entry 2228 (class 2620 OID 24637)
...
--
-- TOC entry 2215 (class 2620 OID 16773)
...
--
-- TOC entry 2216 (class 2620 OID 16774)
...
--
-- TOC entry 2217 (class 2620 OID 16775)
...
--
-- TOC entry 2218 (class 2620 OID 16776)
...
--
-- TOC entry 2229 (class 2620 OID 24638)
...
--
-- TOC entry 2220 (class 2620 OID 16777)
...
--
-- TOC entry 2221 (class 2620 OID 16778)
...
--
-- TOC entry 2222 (class 2620 OID 16779)
...
--
-- TOC entry 2223 (class 2620 OID 16780)
...
--
-- TOC entry 2224 (class 2620 OID 16781)
...
--
-- TOC entry 2219 (class 2620 OID 16782)
...
--
-- TOC entry 2226 (class 2620 OID 16783)
...
--
-- TOC entry 2227 (class 2620 OID 16784)
...
--
-- TOC entry 2172 (class 2606 OID 16785)
...
--
-- TOC entry 2173 (class 2606 OID 16790)
...
--
-- TOC entry 2174 (class 2606 OID 16795)
...
--
-- TOC entry 2175 (class 2606 OID 16800)
...
--
-- TOC entry 2176 (class 2606 OID 16805)
...
--
-- TOC entry 2177 (class 2606 OID 16810)
...
--
-- TOC entry 2178 (class 2606 OID 16815)
...
--
-- TOC entry 2179 (class 2606 OID 16820)
...
--
-- TOC entry 2180 (class 2606 OID 16825)
...
--
-- TOC entry 2186 (class 2606 OID 24728)
...
--
-- TOC entry 2184 (class 2606 OID 16835)
...
--
-- TOC entry 2185 (class 2606 OID 16840)
...
--
-- TOC entry 2189 (class 2606 OID 24693)
...
--
-- TOC entry 2187 (class 2606 OID 16850)
...
--
-- TOC entry 2188 (class 2606 OID 16855)
...
--
-- TOC entry 2181 (class 2606 OID 16860)
...
--
-- TOC entry 2182 (class 2606 OID 16865)
...
--
-- TOC entry 2192 (class 2606 OID 24698)
...
--
-- TOC entry 2190 (class 2606 OID 16875)
...
--
-- TOC entry 2191 (class 2606 OID 16880)
...
--
-- TOC entry 2207 (class 2606 OID 24602)
...
--
-- TOC entry 2208 (class 2606 OID 24607)
...
--
-- TOC entry 2209 (class 2606 OID 24612)
...
--
-- TOC entry 2210 (class 2606 OID 24617)
...
--
-- TOC entry 2211 (class 2606 OID 24622)
...
--
-- TOC entry 2212 (class 2606 OID 24627)
...
--
-- TOC entry 2213 (class 2606 OID 24632)
...
--
-- TOC entry 2193 (class 2606 OID 16890)
...
--
-- TOC entry 2194 (class 2606 OID 16895)
...
--
-- TOC entry 2195 (class 2606 OID 16900)
...
--
-- TOC entry 2196 (class 2606 OID 16905)
...
--
-- TOC entry 2198 (class 2606 OID 16915)
...
--
-- TOC entry 2203 (class 2606 OID 24663)
...
--
-- TOC entry 2201 (class 2606 OID 24653)
...
--
-- TOC entry 2202 (class 2606 OID 24658)
...
--
-- TOC entry 2204 (class 2606 OID 24703)
...
--
-- TOC entry 2199 (class 2606 OID 16920)
...
--
-- TOC entry 2200 (class 2606 OID 16925)
...
--
-- TOC entry 2205 (class 2606 OID 16930)
...
--
-- TOC entry 2206 (class 2606 OID 16935)
...
-- Completed on 2014-05-01 15:42:10
