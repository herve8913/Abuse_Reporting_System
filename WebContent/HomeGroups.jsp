        ...
        <div class="navbar-collapse collapse">
          ...
          <%if(userType==2) {%>
            ...
            <ul class="dropdown-menu">
                ...
                <li class="active"><a href="<%= response.encodeUrl(request.getContextPath() + "/CreateHomeGroup?action=homegroup") %>">Home Groups</a></li>
...
<div class="container">
    <div class="row">
      ...
      <div class="row">
      	  ...
      	  <a id="btn-create" type="button" class="btn btn-primary" href="<%= response.encodeUrl(request.getContextPath() + "/CreateHomeGroup?action=newgrouphome") %>"><i class="glyphicon glyphicon-plus"></i>&nbsp;New Home Group</a>
        </div>
            ...
            <table class="col-md-12 table-bordered table-striped table-condensed cf " style="padding:0px; width: 100%;">
        		...
        		<tbody class="searchable">
        			...
        			for(GroupHome groupHome: listOfGroupHome) {i++;%><tr >
						...
						<a id="button" class="btn btn-primary btn-xs" href="<%= response.encodeUrl(request.getContextPath() + "/CreateHomeGroup?action=updategrouphome&groupHomeId="+groupHome.getId()) %>"><i class="glyphicon glyphicon-cog"></i>&nbsp;Modify</a>
						</div>
						</td>
        			</tr><%} %>
...
<div class="modal fade" id="myModal<%=j %>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <form method="post" action="<%= response.encodeUrl(request.getContextPath() + "/CreateHomeGroup?action=dodeletegrouphome") %>">
