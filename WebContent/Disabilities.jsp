        ...
        <div class="navbar-collapse collapse">
          ...
          <%if(userType==2) {%>
            ...
            <ul class="dropdown-menu">
                ...
                <li class="active"><a href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=disability") %>">Disabilities</a></li>
            ...
            <table class="col-md-12 table-bordered table-striped table-condensed cf " style="padding:0px; width: 100%;">
        		...
        		<tbody class="searchable">
        			...
        			for(Disability disability: listOfDisability) {i++;%><tr >
						...
						<a id="button" class="btn btn-primary btn-xs" href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=updatedisability&disabilityId="+disability.getId()) %>"><i class="glyphicon glyphicon-cog"></i>&nbsp;Modify</a>
						</div>
						</td>
        			</tr><%} %>
