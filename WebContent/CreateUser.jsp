...
<div class="container">
    <div class="row">
      ...
      <div class="row">
      	  <form  name="frmForm" class="form-horizontal" method="post" action="<%= response.encodeUrl(request.getContextPath() + "/CreateUser?action=docreateuser") %>">
			<fieldset>
			<legend>New User   <font color="red"> <c:out value="${message}" /></font></legend> 
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				<a href="<%= response.encodeUrl(request.getContextPath() + "/CreateUser?action=user") %>" id="cancel" name="cancel" class="btn btn-default">Cancel</a>
